                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="start_year" value="2016"
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="end_year" value="2020"
                                    class="w-full bg-black/40 border border-white/10 rounded-sm px-4 py-2.5 text-white outline-none focus:border-[#730c1e] transition-all text-sm font-medium">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="degree" value="Bachelor of Software Engineering"
                                class="w-full bg-black/40 border border-white/10 rounded-sm px-4 py-2.5 text-white outline-none focus:border-[#730c1e] transition-all text-sm font-medium">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="institution" value="University of Technology"
                                class="w-full bg-black/40 border border-white/10 rounded-sm px-4 py-2.5 text-white outline-none focus:border-[#730c1e] transition-all text-sm font-medium">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="description" rows="6"
                                class="w-full bg-black/40 border border-white/10 rounded-sm px-4 py-3 text-white outline-none focus:border-[#730c1e] transition-all resize-none text-sm leading-relaxed font-light">Graduated with Honors. Focused on Distributed Systems and Graphics Programming. Research focused on scalable microservices and real-time data processing.</textarea>
                        </div>
                    </div>
                </div>
