                            ...
                            <div class="text-center">
                                <div id="icon-preview" class="mb-3">
                                    @if($technology->path_icon)
                                        <img src="https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/{{ $technology->path_icon }}.svg" alt="{{ $technology->path_icon }}" class="w-12 h-12 mx-auto" style="filter: invert(1);">
                                    @else
                                        <i data-lucide="help-circle" class="w-12 h-12 text-gray-600 mx-auto"></i>
                                    @endif
                                </div>
                                <p id="icon-name" class="text-xs text-gray-500">{{ $technology->path_icon ?? 'Type icon name to preview' }}</p>
                                <p id="icon-status" class="text-[9px] text-gray-600 mt-1">{{ $technology->path_icon ? '✓ Icon found' : '' }}</p>
                            </div>
                        </div>
