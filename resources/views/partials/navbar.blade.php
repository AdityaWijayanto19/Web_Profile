<nav id="navbar" class="fixed top-0 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] flex items-center justify-between px-6 md:px-12 py-4 border-b border-borderMuted/50 bg-[#08050a]/40 backdrop-blur-xl rounded-2xl z-[100]">
