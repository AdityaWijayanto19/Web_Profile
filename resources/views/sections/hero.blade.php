    ...
    @if ($hero)
        <main
            ...
            <div class="w-full md:w-3/5 space-y-12 z-10 text-left pt-20 md:pt-0">
                <div class="space-y-6 pt-14">
                    <h1 class="text-6xl md:text-[100px] font-bold tracking-tighter leading-[0.85] flex flex-col italic">
                        ...
                        <span
                            class="text-primary drop-shadow-[0_0_40px_rgba(244,63,94,0.25)]">{{ strtoupper($hero->nama_belakang) }}</span>
                    </h1>
            ...
            <div
                ...
                <img src="{{ $hero->path_foto ? asset('storage/' . $hero->path_foto) : asset('assets/images/me.png') }}"
                    alt="Profile"
