...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto px-4">
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-white mb-2">Edit Article Metadata</h1>
            <p class="text-gray-400">Update featured image and metadata for published article.</p>
        </div>

        <form method="POST" action="<?php echo e(route('article.update-metadata', $artikel->id)); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="button-group">
                <a href="<?php echo e(route('article.index')); ?>" class="btn btn-secondary">
                    Back
                </a>
