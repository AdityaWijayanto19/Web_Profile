                    ...
                    <div class="grid grid-cols-12 gap-4 p-4 hover:bg-black/20 transition-colors">
                        ...
                        <div class="col-span-4 flex items-center gap-2">
                            ...
                            <form action="<?php echo e(route('technologies.destroy', $tech)); ?>" method="POST" class="inline"
                                ...
                                <button type="button"
                                data-delete-btn
                                    data-technology-name="<?php echo e(addslashes($tech->nama)); ?>"
                                    data-delete-url="<?php echo e(route('technologies.destroy', $tech)); ?>"
...
<?php $__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/admin/technology/index.js']); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Web Profile\resources\views/admin/technology/index.blade.php ENDPATH**/ ?>
