                        ...
                        <div
                            ...
                            <div class="absolute inset-0 h-full w-full [backface-visibility:hidden]">
                                <div
                                    ...
                                    <?php if($cert->path_gambar): ?>
                                        <img src="<?php echo e(asset('storage/' . $cert->path_gambar)); ?>"
                                            alt="<?php echo e($cert->nama_sertifikat); ?>" class="h-full w-full object-cover">
                                    <?php else: ?>
                                        <div
                                    ...
                                    <div class="absolute bottom-3 left-3 flex items-center gap-2 p-1">
                                        <div class="flex flex-col">
                                            <span
                                                class="text-white font-black text-sm line-clamp-1"><?php echo e($cert->nama_sertifikat); ?></span>
                                            <span class="text-white/60 text-xs line-clamp-1"><?php echo e($cert->tahun); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php $__currentLoopData = $sertifikats->slice(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group h-[180px] [perspective:1000px]">
                            <div
                                class="relative h-full w-full rounded-xl transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] shadow-lg">
                                <div class="absolute inset-0 h-full w-full [backface-visibility:hidden]">
                                    <div class="h-full w-full rounded-lg overflow-hidden border border-white/10 relative shadow-lg">
                                        <?php if($cert->path_gambar): ?>
                                            <img src="<?php echo e(asset('storage/' . $cert->path_gambar)); ?>"
                                                alt="<?php echo e($cert->nama_sertifikat); ?>" class="h-full w-full object-cover">
                                        <?php else: ?>
                                        ...
                                        <div class="absolute bottom-3 left-3 flex items-center gap-2 p-1">
                                            <div class="flex flex-col">
                                                <span class="text-white font-black text-sm line-clamp-1"><?php echo e($cert->nama_sertifikat); ?></span>
                                                <span class="text-white/60 text-xs line-clamp-1"><?php echo e($cert->tahun); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col h-full">
                                        <div class="flex-1">
                                            ...
                                            <h4 class="text-sm font-bold text-white leading-tight tracking-tight mb-2 line-clamp-2">
                                                <?php echo e($cert->nama_sertifikat); ?></h4>
                                            <div class="h-[1px] w-8 bg-primary mb-3"></div>
                                            <p class="text-[10px] text-textMuted leading-relaxed font-light line-clamp-2">
                                                <?php echo e($cert->deskripsi ?? 'Professional certification from industry leaders.'); ?>
                                        ...
                                        <div class="mt-auto pt-3 border-t border-white/5 flex items-center justify-between">
                                            <div class="flex flex-col gap-0.5">
                                                <span class="text-[7px] text-textMuted uppercase font-bold tracking-widest">Year</span>
                                                <span class="text-[9px] text-white font-mono uppercase"><?php echo e($cert->tahun); ?></span>
                                            </div>
                                            <a href="#"
                                                class="group/btn flex items-center gap-1.5 bg-primary/10 hover:bg-primary px-2 py-1 rounded-lg transition-all duration-300">
                                                <span class="text-[8px] font-black uppercase tracking-widest text-white">View</span>
                                                <i data-lucide="external-link" class="w-3 h-3 text-white"></i>
                                            </a>
                                        </div>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            expandBtn.addEventListener('click', () => {
                ...
                if (expandText) {
                    expandText.textContent = isExpanded ? 'Show Less Certificates' : 'View All Certificates';
                }
