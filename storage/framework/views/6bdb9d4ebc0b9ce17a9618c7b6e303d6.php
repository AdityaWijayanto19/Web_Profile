    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <?php if($footers->isEmpty()): ?>
            <div class="bg-[#1a151d] border border-white/5 rounded-sm p-8 text-center">
                <p class="text-gray-400 text-sm">Tidak ada data footer</p>
            </div>
        <?php else: ?>
            <div class="space-y-3">
                <?php $__currentLoopData = $footers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        class="bg-[#1a151d] border border-white/5 rounded-sm p-3 hover:bg-white/[0.01] transition-colors group">
                            ...
                            <div class="flex items-start gap-3 flex-1 min-w-0">
                                ...
                                <?php else: ?>
                                    <div
                                        ...
                                        <span
                                            class="text-xs font-bold text-white"><?php echo e(substr($footer->nama_web, 0, 1)); ?></span>
                                    </div>
                                <?php endif; ?>
                                                ...
                                                <a href="<?php echo e($media->url); ?>" target="_blank" rel="noopener noreferrer"
                                                    ...
                                                    <?php if($media->technology?->path_icon): ?>
                                                        <img src="https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/<?php echo e($media->technology->path_icon); ?>.svg"
                                                            alt="<?php echo e($media->technology->nama); ?>" class="w-3 h-3"
