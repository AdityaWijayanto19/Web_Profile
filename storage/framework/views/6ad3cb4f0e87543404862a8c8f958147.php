...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <!-- Alert Box -->
            <div class="alert">
                <strong>Important:</strong> This reset link will expire in <strong><?php echo e($expiresIn); ?> minutes</strong>
            </div>

            <!-- Reset Button -->
            <div class="button-container">
                <a href="<?php echo e($resetUrl); ?>" class="reset-button">Reset Your Password</a>
            </div>
...
<?php /**PATH C:\laragon\www\Web Profile\resources\views/emails/reset-password.blade.php ENDPATH**/ ?>