                        ...
                        <div class="space-y-3">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <label class="cursor-pointer group">
                                    <input type="radio" name="status" value="draft" class="peer sr-only" <?php echo e(old('status', 'draft') === 'draft' ? 'checked' : ''); ?> />
                                ...
                                <label class="cursor-pointer group">
                                    <input type="radio" name="status" value="published" class="peer sr-only" <?php echo e(old('status') === 'published' ? 'checked' : ''); ?> />
