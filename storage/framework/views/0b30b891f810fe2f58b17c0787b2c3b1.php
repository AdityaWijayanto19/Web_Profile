<?php $__env->startSection('title', 'Articles Management'); ?>
<?php $__env->startSection('page_title', 'Articles Management'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="flex gap-4 mb-6 border-b border-white/5">
            <button class="tab-button active" data-tab="drafts">
                Drafts <span class="text-gray-500"><?php echo e($draftArticles->total()); ?></span>
            </button>
            <button class="tab-button" data-tab="published">
                Published <span class="text-gray-500"><?php echo e($publishedArticles->total()); ?></span>
            </button>
        </div>

        <!-- Draft Articles -->
        <div id="drafts-tab" class="tab-content">
            <?php if($draftArticles->count() > 0): ?>
                <div class="bg-[#1a151d] border border-white/5 rounded-sm overflow-hidden">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $draftArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $artikel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr
                                    class="group border-b border-white/5 transition-colors duration-200 hover:bg-white/[0.02]">
                                    <td class="px-4 py-4 text-center">
                                        <span class="text-gray-500 text-xs font-medium"><?php echo e($key + 1); ?></span>
                                    </td>
                                    <td class="px-4 py-4">
                                        <div>
                                            ...
                                            <div class="text-gray-500 text-[10px] mt-1 line-clamp-1">
                                                <?php echo e($artikel->meta_description ?: 'No description'); ?>
                                    ...
                                    <td class="px-4 py-4 font-mono text-xs text-gray-500">
                                        <?php echo e($artikel->created_at->format('M d, Y')); ?>

                                    </td>
                                    <td class="px-4 py-4 text-right">
                                        <div class="flex justify-end gap-2">
                                            <a href="<?php echo e(route('article.edit', $artikel->id)); ?>"
                                                class="p-1.5 hover:bg-white/10 rounded text-gray-400 hover:text-white transition-colors"
                                                title="Edit">
                                                <i data-lucide="edit-3" class="w-4 h-4"></i>
                                            </a>
                                            <a href="<?php echo e(route('article.publish-form', $artikel->id)); ?>"
                ...
                <div class="mt-4 text-[10px] text-gray-600 uppercase font-bold tracking-widest">
                    <p>Total: <?php echo e($draftArticles->total()); ?> draft articles</p>
                </div>
            <?php else: ?>
        ...
        <div id="published-tab" class="tab-content hidden">
            <?php if($publishedArticles->count() > 0): ?>
                <div class="bg-[#1a151d] border border-white/5 rounded-sm overflow-hidden">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="border-b border-white/5 bg-black/20">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $publishedArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $artikel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr
                                    class="group border-b border-white/5 transition-colors duration-200 hover:bg-white/[0.02]">
                                    <td class="px-4 py-4 text-center">
                                        <span class="text-gray-500 text-xs font-medium"><?php echo e($key + 1); ?></span>
                                    ...
                                    <td class="px-4 py-4 font-mono text-xs text-gray-500">
                                        <?php echo e($artikel->tanggal_rilis?->format('M d, Y') ?: 'N/A'); ?>
                ...
                <div class="mt-4 text-[10px] text-gray-600 uppercase font-bold tracking-widest">
                    <p>Total: <?php echo e($publishedArticles->total()); ?> published articles</p>
                </div>
            <?php else: ?>
                <div class="col-span-full py-16 text-center">
                    <i data-lucide="inbox" class="w-16 h-16 text-gray-600 mx-auto mb-4"></i>
