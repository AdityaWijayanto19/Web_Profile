<?php $__env->startSection('title', $proyek->judul . ' - FoxHR'); ?>
        ...
        <div class="flex justify-between items-end mb-12 border-b border-white/5 pb-8">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    <h2 class="text-3xl font-black text-white tracking-tighter uppercase italic"><?php echo e($proyek->judul); ?></h2>
                    <div
                        class="px-2 py-0.5 <?php echo e($proyek->status === 'published' ? 'bg-green-600' : 'bg-yellow-600'); ?> border border-white/10 rounded-sm text-[9px] text-white font-bold uppercase tracking-widest">
                        <?php echo e($proyek->status); ?>
                ...
                <div class="relative group">
                    <div class="aspect-video bg-[#0f0d11] border border-white/5 overflow-hidden rounded-sm">
                        <?php if($proyek->path_gambar): ?>
                            <img src="<?php echo e(asset('storage/' . $proyek->path_gambar)); ?>" alt="<?php echo e($proyek->judul); ?>"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-3 mt-4">
                            <?php if($proyek->link_demo): ?>
                                <a href="<?php echo e($proyek->link_demo); ?>" target="_blank"
                            ...
                            <?php if($proyek->link_repo): ?>
                                <a href="<?php echo e($proyek->link_repo); ?>" target="_blank"
            ...
            <div class="col-span-12 lg:col-span-7 space-y-12">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed font-medium">
                        <?php echo e($proyek->deskripsi ?? 'No description provided for this project.'); ?>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-8 pt-10 border-t border-white/5">
                    <div>
                        ...
                        <p class="text-xl font-mono text-white italic">
                            #<?php echo e(str_pad($proyek->urutan, 2, '0', STR_PAD_LEFT)); ?></p>
                    </div>
                    <div>
                        <span class="meta-label">Deployment Date</span>
                        <p class="text-sm font-bold text-gray-300 uppercase"><?php echo e($proyek->created_at->format('M d, Y')); ?>

                        </p>
                    </div>
                    <div>
                        <span class="meta-label">Last Revision</span>
                        <p class="text-sm font-bold text-gray-300 uppercase"><?php echo e($proyek->updated_at->format('M d, Y')); ?>
