...
<div class="max-w-[1200px]">
    ...
    <form action="<?php echo e(route('projects.update', ['project' => $proyek->id ?? 1])); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between p-6 bg-[#1a151d] border border-white/5 rounded-sm shadow-xl">
                    <a href="<?php echo e(route('projects.index')); ?>" class="text-xs font-bold text-gray-500 hover:text-white transition-colors uppercase tracking-widest">
                        Cancel
                    </a>
                    ...
                    <div class="relative aspect-video rounded-sm overflow-hidden border border-white/5 bg-black mb-4">
                        <div class="absolute inset-0 bg-gradient-to-b from-black/20 to-black/80 flex items-center justify-center">
                            <?php if($proyek->path_gambar): ?>
                                <img id="preview-image" src="<?php echo e(asset('storage/' . $proyek->path_gambar)); ?>" alt="Preview" class="w-full h-full object-cover">
                            <?php else: ?>
                        ...
                        <label class="absolute inset-0 flex flex-col items-center justify-center bg-black/50 opacity-0 hover:opacity-100 transition-opacity cursor-pointer">
                            ...
                            <input type="file" name="gambar" id="image-input" class="hidden" accept="image/*" <?php $__errorArgs = ['gambar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <label class="cursor-pointer group">
                                    <input type="radio" name="status" value="draft" class="peer sr-only" <?php echo e(old('status', $proyek->status) === 'draft' ? 'checked' : ''); ?> />
                                ...
                                <label class="cursor-pointer group">
                                    <input type="radio" name="status" value="published" class="peer sr-only" <?php echo e(old('status', $proyek->status) === 'published' ? 'checked' : ''); ?> />
