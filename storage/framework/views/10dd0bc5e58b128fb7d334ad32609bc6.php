        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            <div class="flex items-center gap-2">
                <span class="text-[9px] text-gray-500 font-bold uppercase tracking-widest">ID:
                    <?php echo e(str_pad($proyek->id, 4, '0', STR_PAD_LEFT)); ?></span>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <label class="text-[10px] font-bold text-gray-500 uppercase tracking-[0.1em]">Urutan saat
                                    ini:<?php echo e($proyek->urutan); ?></label>
...
<?php $__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/admin/project/edit.js']); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Web Profile\resources\views/admin/project/edit.blade.php ENDPATH**/ ?>