...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <a href="<?php echo e(route('sertifikats.index')); ?>" class="flex items-center gap-2 text-[10px] font-bold tracking-widest text-gray-500 hover:text-[#730c1e] transition-colors">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="tahun" placeholder="e.g. 2024" min="1900" max="<?php echo e(date('Y')); ?>"
