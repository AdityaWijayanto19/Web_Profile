...
unset($__errorArgs, $__bag); ?>
                            ...
                            <label class="text-[10px] font-bold text-gray-500 uppercase tracking-[0.1em]">Urutan saat ini:<?php echo e($newOrder); ?></label>
                        </div>
                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/admin/sertifikat/create.js']); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Web Profile\resources\views/admin/sertifikat/create.blade.php ENDPATH**/ ?>