...
<div class="max-w-2xl mx-auto">
    <!-- Breadcrumb -->
    <div class="mb-6">
        <a href="<?php echo e(route('technologies.index')); ?>" class="inline-flex items-center gap-2 text-xs text-gray-500 hover:text-[#730c1e] transition-colors group">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="space-y-2">
                            <input type="text" name="path_icon" id="icon-input" placeholder="e.g. react, laravel, ubuntu, python"
                                value="<?php echo e(old('path_icon')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-between p-6 bg-[#1a151d] border border-white/5 rounded-sm shadow-xl">
                <a href="<?php echo e(route('technologies.index')); ?>" class="text-xs font-bold text-gray-500 hover:text-white transition-colors uppercase tracking-widest">
                    Cancel
                </a>
