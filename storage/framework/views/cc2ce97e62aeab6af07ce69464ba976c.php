        ...
        <div class="w-full lg:w-[45%] h-full flex flex-col justify-center items-center px-8 md:px-20 bg-white">
            ...
            <div class="w-full max-w-md animate-up">
                ...
                <form action="<?php echo e(route('password.update')); ?>" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" required
                                ...
                                placeholder="••••••••">
                            <button type="button"
                                class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-pink-main toggle-password"
                    ...
                    <!-- Confirm Password -->
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Confirm
                            Password</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400">
                                <i class="fa-solid fa-lock"></i>
