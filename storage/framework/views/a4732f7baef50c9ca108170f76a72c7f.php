                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <ul class="text-xs text-gray-400 space-y-1 list-disc list-inside">
                                <li>Created <?php echo e($technology->created_at->format('d M Y H:i')); ?></li>
                                <li>Last updated <?php echo e($technology->updated_at->format('d M Y H:i')); ?></li>
                                <li>Used in <?php echo e($technology->proyeks->count()); ?> project(s)</li>
                            </ul>
                        </div>
                    </div>
                </div>
