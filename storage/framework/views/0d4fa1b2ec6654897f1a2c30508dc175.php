    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10 text-left">
            <div class="space-y-4">
                ...
                <p class="text-textMuted text-sm">Independent Senior Developer building high-end digital products.</p>
            </div>
            <div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-textMuted text-sm">
                    <li><a href="mailto:aditya@example.com" class="text-primary font-bold">aditya@example.com</a></li>
