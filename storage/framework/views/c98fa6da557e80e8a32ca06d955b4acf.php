        ...
        <div class="relative hidden lg:flex lg:w-[55%] bg-pink-main flex-col justify-between p-16 overflow-hidden">
            ...
            <div class="z-20 flex flex-col justify-between h-full">
                <div class="text-white space-y-6">
                    <h1 class="text-5xl font-bold leading-tight"><?php echo $__env->yieldContent('side_title'); ?></h1>
                    <p class="text-lg text-white/80"><?php echo $__env->yieldContent('side_description'); ?></p>
                </div>

                <div class="flex justify-center items-center py-8">
                    <img src="<?php echo e(asset('assets/images/' . $illustration)); ?>"
...
<?php /**PATH C:\laragon\www\Web Profile\resources\views/layouts/auth.blade.php ENDPATH**/ ?>