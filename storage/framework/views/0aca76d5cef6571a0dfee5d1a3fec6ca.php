...
<div class="max-w-6xl mx-auto">
    ...
    <div class="flex justify-between items-end mb-8 border-b border-white/5 pb-6">
        ...
        <a href="<?php echo e(route('sertifikat.create')); ?>" class="btn-primary text-white px-4 py-2 rounded-sm flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest">
