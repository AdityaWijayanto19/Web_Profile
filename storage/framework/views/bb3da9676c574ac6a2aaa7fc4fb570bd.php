...
<form action="<?php echo e(route('hero-section.update')); ?>" method="POST" enctype="multipart/form-data" class="max-w-6xl mx-auto">
    <?php echo csrf_field(); ?>
        ...
        <div class="col-span-12 lg:col-span-7 bg-[#1a151d] rounded-sm p-5 border border-white/5 relative shadow-sm">
            ...
            <div class="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
                <div class="space-y-1.5">
                    ...
                    <input type="text" id="input-first-name" name="nama_depan" value="<?php echo e($hero->nama_depan ?? 'ADITYA P.'); ?>"
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" id="input-last-name" name="nama_belakang" value="<?php echo e($hero->nama_belakang ?? 'WIJAYANTO'); ?>"
        ...
        <div class="col-span-12 lg:col-span-8 bg-[#1a151d] rounded-sm p-5 border border-white/5 space-y-5 relative shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-4">
                <div class="space-y-1.5">
                    ...
                    <input type="text" id="input-headline" name="text_singkat" value="<?php echo e($hero->text_singkat ?? 'Undergraduate University of Brawijaya'); ?>"
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea id="input-bio" name="deskripsi" rows="2"
                        ...
                        class="w-full form-input-custom rounded-sm px-3 py-2 text-xs leading-relaxed"><?php echo e($hero->deskripsi ?? 'Crafting digital products with immersive aesthetics since 2016.'); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 bg-[#1a151d] rounded-sm border border-white/5 overflow-hidden grid grid-cols-12 relative shadow-sm">
            <div class="col-span-12 md:col-span-8 p-6 flex flex-col justify-center space-y-6">
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="link_cv" value="<?php echo e($hero->link_cv ?? '#contact'); ?>" class="w-full form-input-custom rounded-sm px-3 py-2 text-xs">
                    </div>
                </div>
            ...
            <div class="col-span-12 md:col-span-4 bg-black/40 p-6 flex flex-col items-center justify-center border-l border-white/5">
                <div class="relative group w-32 h-40 border border-dashed border-white/10 rounded-sm flex items-center justify-center overflow-hidden">
                    <img id="preview-portrait" src="<?php echo e($hero && $hero->path_foto ? Storage::disk('public')->url($hero->path_foto) : asset('assets/images/me.png')); ?>" class="w-full h-full object-cover grayscale opacity-40 group-hover:opacity-100 transition-all">
