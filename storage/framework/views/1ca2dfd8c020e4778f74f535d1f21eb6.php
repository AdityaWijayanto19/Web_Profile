<section id="experience" class="relative pt-10 pb-0 px-6 overflow-hidden font-sans">
    ...
    <div class="max-w-6xl mx-auto relative">
        ...
        <div class="relative grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-4 min-h-[450px]">
            <?php $__currentLoopData = $pengalaman->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($index === 0): ?>
                    <!-- Item 1 - Left -->
                        ...
                        <div class="relative z-10 top-0 md:top-24 flex flex-col items-center md:items-start text-center md:text-left">
                            <div class="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-2 relative mb-10">
                                ...
                                <div class="text-center md:text-left">
                                    <h4 class="text-xl font-bold text-primary mb-2"><?php echo e($item->jabatan); ?></h4>
                                    <p class="text-sm text-gray-500 leading-relaxed max-w-[200px]"><?php echo e($item->keterangan); ?></p>
                                </div>
                            </div>
                    ...
                    <div class="relative flex flex-col items-center md:mt-0 group">
                        <div class="relative z-10 top-0 md:top-40 flex flex-col items-center text-center">
                            ...
                            <div class="flex flex-col md:flex-row items-center gap-4 md:gap-2 relative mb-10">
                                ...
                                <div class="text-center md:text-left">
                                    <h4 class="text-xl font-bold text-primary mb-2"><?php echo e($item->jabatan); ?></h4>
                                    <p class="text-sm text-gray-500 leading-relaxed max-w-[240px]"><?php echo e($item->keterangan); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
