...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="start_year" value="<?php echo e(explode(' - ', $sertifikat->tahun)[0] ?? ''); ?>"
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="end_year" value="<?php echo e(explode(' - ', $sertifikat->tahun)[1] ?? ''); ?>"
                                    class="w-full bg-black/40 border border-white/10 rounded-sm px-4 py-2.5 text-white outline-none focus:border-[#730c1e] transition-all text-sm font-medium">
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="number" name="urutan" min="1" max="9999"
                                    value="<?php echo e(old('urutan', $sertifikat->urutan)); ?>"
...
<?php $__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/admin/sertifikat/edit.js']); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Web Profile\resources\views/admin/sertifikat/edit.blade.php ENDPATH**/ ?>